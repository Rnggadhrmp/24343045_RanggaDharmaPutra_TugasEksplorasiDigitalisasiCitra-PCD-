    ...
    for col, (name, patch) in enumerate(color_patches):
        if model == 'RGB':
            ...
            if model == 'HSV':
                ...
                lab[:,:,1:] = lab[:,:,1:] + 128    # a,b from [-127,127] to [0,255]prend
...
# Load sample image
sample_img = cv2.imread('ruang tamu.png')  # Ganti dengan path citra Anda
if sample_img is None:
    ...
    print("Menggunakan citra sintetik (file ruang tamu.png tidak ditemukan)")
